...
void loop()
{
  // lwheel.data =  rmcs.Position_Feedback(slave_id4);  // the function reads the encoder value from the motor with slave id 4
  // rwheel.data = -rmcs.Position_Feedback(slave_id2);  // the function reads the encoder value from the motor with slave id 4
